...
public class Block_Init {
    ...
    public static final Block NOMALLOWSTICK = new Block_NoMallow(FabricBlockSettings.of(Material.WOOD).hardness(0.0f).nonOpaque().collidable(false).ticksRandomly()) {};
